...
import QuisSommeNous from '~/assets/images/quisommesnous.jpg';
import cameraBackImg from '~/assets/images/camera-back.jpg';
import StepsImage from '~/assets/images/steps.jpg';
...
export const contentHomeOne: ContentProps = {
  ...
  header: {
    ...
    subtitle: 'Votre entreprise locale au service de la Côte d\'Azur',
    tagline: 'Découvrez-nous',
  },
  content:
    `Bienvenue chez Reno Services, votre partenaire de confiance pour tous vos besoins en peinture intérieure, bricolage, nettoyage, et bien plus encore. Basés au cœur de la Côte d\'Azur, nous allions expertise, professionnalisme et passion pour vous offrir des services de qualité exceptionnelle.`,
  items: [
    {
      title: 'Une mission au service de vos besoins',
      description:
        'Notre mission est de simplifier votre quotidien en proposant des solutions personnalisées, rapides et efficaces. Que ce soit pour vos projets de rénovation, d’aménagement ou de dépannage, notre équipe expérimentée est à vos côtés pour transformer vos idées en réalité, tout en respectant vos attentes et délais.',
    },
    {
      title: 'Des services adaptés à vos exigences',
      description:
        'Chez Reno Services, nous comprenons l’importance d’un travail bien fait. C’est pourquoi nous mettons un point d’honneur à écouter vos besoins, à vous conseiller et à vous accompagner tout au long de vos projets, avec une attention particulière aux détails et une finition impeccable.',
    },
    {
      title: 'Un engagement envers la qualité',
      description:
        'Nous croyons fermement que votre satisfaction est notre plus grande réussite. En choisissant Reno Services, vous bénéficiez d’un savoir-faire unique, d’un service sur mesure et d’un accompagnement à chaque étape pour des résultats qui dépassent vos attentes.',
    },
  ],
  image: {
    src: QuisSommeNous,
...
export const stepsHome: StepsProps = {
  ...
  header: {
    title: 'Découvrez notre simple process.',
  },
  items: [
    {
      title: 'Demande de devis gratuite',
      description:
        'Vous commencez par remplir notre formulaire de devis gratuit en nous indiquant vos besoins spécifiques et vos attentes.',
      icon: IconArrowDown,
    },
    {
      title: 'Contact personnalisé',
      description:
        'Une fois votre demande reçue, notre équipe vous contacte pour discuter des détails et s\'assurer que nous comprenons parfaitement votre projet.',
      icon: IconArrowDown,
    },
    {
      title: 'Envoi du devis',
      description:
        'Après avoir collecté toutes les informations nécessaires, nous vous envoyons un devis clair et détaillé, adapté à vos besoins.',
      icon: IconArrowDown,
    },
    {
      title: 'Allons s\'y!',
