    ...
    <div className="mx-auto max-w-7xl">
      <div className={`md:flex ${isReversed ? 'md:flex-row-reverse' : ''} md:gap-16`}>
        <div className="self-center md:basis-1/2">
           ...
           Bienvenue chez <strong>Reno Services</strong>, votre partenaire de confiance pour tous vos besoins en peinture intérieure, bricolage, nettoyage, et bien plus encore. Basés au cœur de la Côte d\'Azur, nous allions expertise, professionnalisme et passion pour vous offrir des services de qualité exceptionnelle.
          </div>
          <ItemGrid
            items={items}
            columns={1}
